...
# Header 
st.write('''
# Bouras Ayyoub, Master's Degree Student.
##### *Resume* 
''')
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #16A2CB;">
  <a class="navbar-brand" href="https://youtube.com/dataprofessor" target="_blank">BOURAS AYYOUB</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#bioinformatics-tools">Data Science Tools</a>
      </li>
      <li class="nav-item">
...
txt('**Bachelor in Computer science** , *Moulay Ismail University*, Faculty of science',
'2017-2021')
st.markdown('''
- Grade: `A.Bien`
- PFE : Realiazition of an Application for face emotion detection using Python`.
''')

txt('**Master Degree** (Datta Science and Big Data), *Mohamed 5 University* , Ensias',
'2021-2023')
st.markdown('''
